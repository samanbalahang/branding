...
<main class="w-full bg-white">
    <section>
        <div class="w-full relative">
            ...
            <?php if ($image) {
            ?>
                <div class="hidden md:block card-main-image w-full">
                    <img src="<?= $image['url'] ?>" alt="<?= $image['alt'] ?>" class="w-full">
                </div>
                  <?php
                     }
                     $image = get_field("firstsliderimagemob");
                     if ($image) {
                   ?>
                <div class="block md:hidden card-main-image w-full">
                    <img src="<?= $image['url'] ?>" alt="<?= $image['alt'] ?>" class="w-full">
                </div>
                <?php
                }
                ?>
            <div class="w-full h-full absolute top-0 left-0 flex flex-col justify-end md:justify-center items-end md:items-start md:justify-centee project-slider-text">
    ...
    <section class="mt-8 mb-8">
        <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/2 p-4">
                <div class="flex flex-wrap">
                    <div class="w-22/100 md:w-12/100 p-4">
                        <?= the_field("fistprojectheading") ?>
                    </div>
                    <div class="w-78/100 md:w-88/100 p-4">
